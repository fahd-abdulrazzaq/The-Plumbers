    ...
    <div className='section-container bg-gradient-to-r from-[#FAFAFA] from-0% to-[#FCFCFC] to-100%'>
      <div className='py-24'>
        <div className='p-8 max-w-4xl mx-auto bg-white shadow-lg rounded-lg'>
          <h1 className='text-2xl text-blue font-semibold mb-6'>
            Create a New Course
          </h1>
          <ToggLable buttonLabel='Add New Course'>
                ...
                {modules.map((module, moduleIndex) => (
                  <div key={moduleIndex} className='space-y-4'>
                    ...
                    <button
                      ...
                      className='mt-2  border-2 border-blue p-2 text-blue rounded-md'
                    >
                      + Add Another Lesson
                    </button>
                  </div>
                        ...
                        {question.type === 'Multiple Choice' && (
                          <>
                            ...
                            <button
                              ...
                              className='border-2 border-blue p-2 text-blue rounded-md mt-2'
                            >
                              + Add Option
                            </button>
                          </>
